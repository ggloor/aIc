...
test.cor.clr <- aIc.coherent(selex, group=group, norm.method='clr', log=F)
test.cor.TMM <- aIc.coherent(selex, group=group, norm.method='TMM', log=T)
...
test.dom.clr <- aIc.dominant(selex, group=group, norm.method='clr', log=F)
test.dom.TMM <- aIc.dominant(selex, group=group, norm.method='TMM', log=T)
...
test.scale.clr <- aIc.scale(selex, group=group, norm.method='clr', log=F)
test.scale.TMM <- aIc.scale(selex, group=group, norm.method='TMM', log=T)
...
test.perturb.clr <- aIc.perturb(selex, group=group, norm.method='clr', log=F)
test.perturb.TMM <- aIc.perturb(selex, group=group, norm.method='TMM', log=T)
